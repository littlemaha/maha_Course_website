...
public class validation_login_servlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(va_login.isUser(userName, password)){
			out.print("<script language='javascript'>alert('µÇÂ¼³É¹¦');location='../ch01/main.jsp';</script>");
//			request.getRequestDispatcher("maha/main.jsp");
		} else {
			out.print("<script language='javascript'>alert('µÇÂ¼Ê§°Ü');location='../ch01/login_imitate.jsp';</script>");
		}
